      ...
      <div className="container max-w-screen-xl py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="/submit" className="hover:text-primary transition-colors">Submit a Program</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-border/40 text-center text-xs text-muted-foreground">
          © {new Date().getFullYear()} GoodiesHub. All rights reserved. Made with ❤️ for students.
        </div>
      </div>
    </footer>
  );
